...
class Diabetes(models.Model):
  name = models.CharField(max_length=50, null=True)
  pregnancies = models.PositiveIntegerField(validators=[MinValueValidator(0)], null=True)
  ...
  age = models.PositiveIntegerField(validators=[MinValueValidator(1)], null=True)
